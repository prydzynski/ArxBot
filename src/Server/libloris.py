...
def DefaultOptions():
    return {
        ...
        'attacklimit' : 50,            # Total number of times to attack (0 for unlimited)
        'connectionlimit' : 50,        # Total number of concurrent connections (0 for unlimited)
        'threadlimit' : 20,             # Total number of threads (0 for unlimited)
        ...
        'quitimmediately' : True,      # Close connections immediately after completing request
